...
- 你可以合成某种好吃的?
![](https://img.cdn1.vip/i/691b3d01c228d_1763392769.png)
...
- 更新了备份逻辑，现在服务器会每六小时自动进行一次备份，并只保留最近十次备份。这意味着你可以选择回档到最近六十个小时内以六个小时为间隔的其中一个节点（已废除）
- 更新了一些新的成就
...
- 更新了多个服务器优化mod
  ...
  - VMP  [Github](https://github.com/RelativityMC/VMP-fabric)
    - 优化实体渲染和数据包发送等
  - TT20  [Github](https://github.com/snackbag/tt20)（已废除）
    :::caution
...
- 服务器已同时兼容在线/离线玩家，皮肤和披风已经正常显示（已废除）
